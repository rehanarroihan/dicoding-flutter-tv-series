...
// in ditonton/test/presentation/bloc/show/detail/show_detail_bloc_test.dart.
...
import 'package:core/domain/usecases/get_show_detail.dart' as _i4;
import 'package:core/domain/usecases/get_show_recommendations.dart' as _i8;
import 'package:core/domain/usecases/get_show_watchlist_status.dart' as _i10;
import 'package:core/domain/usecases/remove_from_watchlist.dart' as _i12;
import 'package:core/domain/usecases/save_to_watchlist.dart' as _i11;
...
class MockGetShowDetail extends _i1.Mock implements _i4.GetShowDetail {
  ...
  @override
  _i2.TvShowRepository get repo => (super.noSuchMethod(
...
/// A class which mocks [GetShowWatchlistStatus].
///
/// See the documentation for Mockito's code generation for more information.
class MockGetShowWatchlistStatus extends _i1.Mock
    implements _i10.GetShowWatchlistStatus {
  MockGetShowWatchlistStatus() {
    _i1.throwOnMissingStub(this);
  }
...
/// A class which mocks [SaveToWatchlist].
///
/// See the documentation for Mockito's code generation for more information.
class MockSaveToWatchlist extends _i1.Mock implements _i11.SaveToWatchlist {
  MockSaveToWatchlist() {
    _i1.throwOnMissingStub(this);
  }
  ...
  @override
  _i5.Future<_i3.Either<_i6.Failure, String>> execute(_i7.TvShowDetail? show) =>
      (super.noSuchMethod(
        Invocation.method(
          #execute,
          [show],
...
class MockRemoveFromWatchlist extends _i1.Mock
    implements _i12.RemoveFromWatchlist {
